...
void CommSeqThread::executeRunScript1(bool aResumeFlag)
{
   ...
   if (!aResumeFlag)
   {
      ...
      Prn::print(Prn::Show1, "CommSeqThread::executeRunScript1 BEGIN");
   ...
   try
   {
      ...
      while (true)
      {
         ...
         // Delay.
         mNotify.waitForTimer(gProgramParms.mScriptThrottle);
   ...
   catch(int aException)
   {
      ...
      Prn::print(0, "EXCEPTION CommSeqThread::executeRunScript1 %d %s", aException, mNotify.mException);
   }
   ...
   Prn::print(Prn::Show1, "CommSeqThread::executeRunScript1 END");
}
...
void CommSeqThread::executeRunScript2()
{
   // Print and log.
   Prn::print(0, "");
   Prn::print(0, "running script2");
   Prn::print(Prn::Show1, "CommSeqThread::executeRunScript2 BEGIN");
   Log::TString* tString1 = new Log::TString;
   ...
   {
      mLoopExitCode = cLoopExitAborted;
      Prn::print(0, "EXCEPTION CommSeqThread::executeRunScript2 %d %s", aException, mNotify.mException);
   }
   ...
   Prn::print(Prn::Show1, "CommSeqThread::executeRunScript2 END");
}
...
void CommSeqThread::doRunCmd_Info()
{
...
void CommSeqThread::doRunCmd_Send(int aCode)
{
   // Guard.
...
void CommSeqThread::doRunCmd_Slice()
{
   // Guard.
   if (!Lcd::gGraphicsThread)
   {
      Cmn::gShare.mSliceCount++;
      if (gProgramParms.mSliceCode == 1)
      {
...
void CommSeqThread::doRunCmd_PWM()
{
...
void CommSeqThread::doRunCmd_Test()
{
...
void CommSeqThread::doRunCmd_CMarker()
{
